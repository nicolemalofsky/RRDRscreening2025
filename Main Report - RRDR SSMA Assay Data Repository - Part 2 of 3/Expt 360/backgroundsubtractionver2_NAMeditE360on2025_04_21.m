...
sheetname = "2025-04-21 Expt 360 modified asym pcr and melt_20250423_095416.xlsx.xlsx";
...
for sample = 1:length(LCtemp(1,:))
    ...
    mintemp = 70; % represents the starting temp at which possible Tm's will be grabbed 
